...
export function PricingSection({ cityName, serviceId, serviceName }: PricingSectionProps) {
  ...
  const intro = cityName
    ...
    : 'Prices vary depending on the type, material, and specification. Below are typical costs from installers in our LOCATION_DISPLAY network. All prices are in GBP and include installation.';
